...
<html
  ...
  <head>
    ...
    <c:url
      value="/css/fixTableBootstrap.css"
      var="fixTableBootstrap" />
    <link
      rel="stylesheet"
      href="${fixTableBootstrap}" />
    ...
    <!-- tooltips -->
    <c:url
      value="/js/globalTooltips.js"
      var="globalTooltips" />
    <script
      defer
      src="${globalTooltips}"></script>
  ...
  <body class="h-100">
    <div class="h-100 d-flex">
      ...
      <!-- Main body -->
      <div
        class="h-100 d-flex flex-column overflow-x-hidden"
        style="flex: 1">
        <!-- Header -->
