<%-- Document : feedback Created on : Aug 11, 2023, 1:52:07 AM Author : Duc Hung
      ...
      <tbody class="table-group-divider">
        <c:forEach items="${feedbacks}" var="f">
          <tr>
            ...
            <td>${f.comment}</td>
            <td>
              ${f.ticketId.tripId.routeId.startLocation} -
              ${f.ticketId.tripId.routeId.endLocation}
            </td>
            <td>${f.ticketId.userId}</td>
            <td>
              <div class="btn-group float-end">
                <c:url
                  value="/feedbacks/edit?feedbackId=${f.id}&tripId=${f.ticketId.tripId.id}"
                  var="update"
                />
                ...
                <c:url value="/api/admin/feedbacks/${f.id}" var="delUrl" />
