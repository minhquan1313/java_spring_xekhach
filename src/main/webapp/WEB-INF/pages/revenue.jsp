    ...
    <div class="container">
      <div class="input-group">
        <input
          type="text"
          class="form-control"
          placeholder='<spring:message code="ui.global.year" />'
          id="year"
          value="${year}"
        />
        <!--  -->
        ...
        <div class="col-12 col-lg">
          <div class="input-group">
            <input
              type="text"
              class="form-control"
              placeholder='<spring:message code="ui.revenue.year_start" />'
              id="yearStart"
              value="${yearStart}"
            />
            <!--  -->
        ...
        <div class="col-12 col-lg">
          <div class="input-group">
            <input
              type="text"
              class="form-control"
              placeholder='<spring:message code="ui.revenue.year_end" />'
              id="yearEnd"
              value="${yearEnd}"
            />
