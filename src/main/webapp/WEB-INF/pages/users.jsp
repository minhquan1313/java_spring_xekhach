...
<section class="container py-4">
  <div class="d-flex align-items-center mb-3">
    <div class="d-flex justify-content-start" style="flex: 1">
      <c:choose>
        <c:when
          test="${not empty param.id or not empty param.kw or not empty param.roleId}"
        >
    ...
    <form class="d-flex w-100" action="${action}">
      <div class="flex-grow-1 me-2">
        <input
          ...
          name="kw"
          placeholder='<spring:message code="ui.user.type_keyword" />'
          value="${param.kw}"
        />
      </div>
      <div class="me-2">
          ...
          <tr>
            ...
            <td>
              <div class="btn-group float-end">
                <c:url value="/users/edit/${u.id}" var="api" />
                <a href="${api}" class="btn btn-primary">
                  <spring:message code="ui.global.edit" />
                </a>

                <c:url value="/api/admin/users/${u.id}" var="delUrl" />
