...
public class RevenueController {
    ...
    public String index(Model model, @RequestParam Map<String, String> params, Locale locale) {
        ...
        String multiLangDoanhThuNam = messageResource.getMessage("con.revenue.chart.revenue_months_of_year", null,
                locale);
        String multiLangDoanhThuTuNamDenNay = messageResource.getMessage(
                "con.revenue.chart.revenue_in_years_from_to_now",
                null, locale);
        String multiLangDoanhThuTuNamDenNam = messageResource.getMessage("con.revenue.chart.revenue_in_years_from_to",
                null, locale);
        ...
        revenueByMonthsCurrentYChartJs
                .setTableName(Utils.replaceFromMessageBean(multiLangDoanhThuNam, String.valueOf(_year)));
            ...
            revenueByMonthsIn5YearsChartJs
                    .setTableName(
                            Utils.replaceFromMessageBean(multiLangDoanhThuTuNamDenNay,
                                    String.valueOf(_yearEnd - _yearStart), String.valueOf(_yearStart)));
        } else {
            // till a year
            revenueByMonthsIn5YearsChartJs
                    .setTableName(
        ...
        List<TitleAndValue> revenueByQuarters = statsService.revenueByQuarters(_year, multiLangDoanhThuCacQuyTrongNam);
        ...
        revenueByQuartersChartJs
                .setTableName(Utils.replaceFromMessageBean(multiLangDoanhCacQuy, String.valueOf(_year)));
